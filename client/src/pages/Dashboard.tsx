...
const Dashboard = () => {
  ...
  const totalCalories: number =
    todayFood.reduce((total, item) => total + item.calories, 0) -
    todayActivities.reduce((sum, item) => sum + item.calories, 0);
          ...
          <Card className="bg-linear-to-r from-slate-800 to-slate-700">
            ...
            <Card>
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-slate-100 dark:text-slate-800">
