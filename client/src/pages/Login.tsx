    ...
    <Toaster />
        <main className="login-page-container">
          <form onSubmit={handleSubmit} className="login-form">
            ...
            {state !== 'login' && (
              <div className="mt-4">
                <label className="font-medium text-sm-gray-700
            ...
            <div className="mt-4">
              ...
              ? (
                ...
                dark:text-gray-400">Don't have an account? <button onClick={()=> setState('sign-up')} className="ml-1 cursor-pointer text-green-600
                hover:underline">Sign up</button></p>
                  )
               :
               (
                <p className="text-center py-6 text-sm text-gray-500
                dark:text-gray-400">Already have an account? <button onClick={()=> setState('login')}className="ml-1 cursor-pointer text-green-600
