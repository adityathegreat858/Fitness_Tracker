...
const Onboarding = () => {
  ...
  const handleNext = async ()=>{
    ...
    if(step < totalSteps){
      ...
      await apiClient.user.update(user?.id || "", userData as unknown as | Partial<UserData>)
          ...
          {step === 3 && (
            <div className="space-y-6 onboarding-wrapper">
              <div className="flex items-center gap-4 mb-8">
                 ...
                 <div>
                   ...
                   <p className="text-slate-500 dark:text-slate-400 text-sm">We'll tailor your experience to your goals</p>
                  </div>
              </div>
            ...
            <div className="space-y-8 max-w-lg">
              ...
              <div className="space-y-6">
                ...
                value={formData.dailyCalorieBurn} onChange={(v)=>updateField('dailyCalorieBurn', v)} unit="kcal" infoText="The total calories you plan to burn through exercise and activity each day."/>
              </div>
            </div>
            </div>
          )}
